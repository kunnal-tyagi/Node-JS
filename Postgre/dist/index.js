...
const client = new Client({
    connectionString: "postgresql://neondb_owner:npg_9fB7FTYhgwRv@ep-orange-smoke-a1r4stwg-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
});
...
// ✅ Insert function
async function InsertData(username, password, age) {
    try {
        const inserting = `

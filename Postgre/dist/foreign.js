...
async function main() {
    ...
    `);
        ...
        // Insert into users
        const userRes = await client.query(`INSERT INTO workers (username, age)
       VALUES ($1, $2)
       RETURNING id`, ['kunnal', 20]);
        const userId = userRes.rows[0].id;
        // Insert into address using same user_id
        await client.query(`INSERT INTO address (user_id, address)
       VALUES ($1, $2)`, [userId, 'Ghaziabad, U.P.']);
